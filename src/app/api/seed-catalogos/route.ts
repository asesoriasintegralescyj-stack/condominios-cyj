...
const tareasMaster = [
  ...
  // ============================================
  // LISTAS DE VERIFICACIÓN — PMI LAGUNA NORTE
  // (LV-01 a LV-20 según documento oficial)
  // ============================================
  { codigo: 'LV-01', nombre: 'Dotación diaria de personal y EPP', categoria: 'General', sistema: 'Personal y EPP', tipoMantencion: 'Preventivo', frecuencia: 'Diaria', responsable: 'Jefe de Mantenimiento', tiempoEstimado: 30, centroCostoCodigo: 'CC-ADM-01', esRecurrente: true },
  { codigo: 'LV-02', nombre: 'Laguna artificial — Control diario de agua', categoria: 'Piscina', sistema: 'Laguna Artificial', tipoMantencion: 'Rutina', frecuencia: 'Diaria', responsable: 'Operario de Laguna', tiempoEstimado: 60, centroCostoCodigo: 'CC-PIS-01', esRecurrente: true },
  { codigo: 'LV-03', nombre: 'Piscinas 1-2-3 — Control diario de agua y limpieza', categoria: 'Piscina', sistema: 'Piscinas', tipoMantencion: 'Rutina', frecuencia: 'Diaria', responsable: 'Operario de Piscinas', tiempoEstimado: 90, centroCostoCodigo: 'CC-PIS-01', esRecurrente: true },
  { codigo: 'LV-04', nombre: 'Playas artificiales — Rastrillado y limpieza diaria', categoria: 'Áreas Verdes', sistema: 'Playas', tipoMantencion: 'Rutina', frecuencia: 'Diaria', responsable: 'Operario Laguna + Jardinero', tiempoEstimado: 120, centroCostoCodigo: 'CC-ARV-01', esRecurrente: true },
  { codigo: 'LV-05', nombre: 'Aseo y limpieza áreas comunes', categoria: 'Aseo', sistema: 'Áreas Comunes', tipoMantencion: 'Rutina', frecuencia: 'Diaria', responsable: 'Auxiliar de Aseo', tiempoEstimado: 180, centroCostoCodigo: 'CC-ASE-01', esRecurrente: true },
  { codigo: 'LV-06', nombre: 'Inspección visual juegos infantiles', categoria: 'Infraestructura', sistema: 'Juegos Infantiles', tipoMantencion: 'Preventivo', frecuencia: 'Diaria', responsable: 'Auxiliar de Servicios Generales', tiempoEstimado: 30, centroCostoCodigo: 'CC-INF-01', esRecurrente: true },
  { codigo: 'LV-07', nombre: 'Laguna — Control semanal técnico', categoria: 'Piscina', sistema: 'Laguna Artificial', tipoMantencion: 'Preventivo', frecuencia: 'Semanal', responsable: 'Operario de Laguna', tiempoEstimado: 120, centroCostoCodigo: 'CC-PIS-01', esRecurrente: true },
  { codigo: 'LV-08', nombre: 'Piscinas — Mantenimiento semanal', categoria: 'Piscina', sistema: 'Piscinas', tipoMantencion: 'Preventivo', frecuencia: 'Semanal', responsable: 'Operario de Piscinas', tiempoEstimado: 180, centroCostoCodigo: 'CC-PIS-01', esRecurrente: true },
  { codigo: 'LV-09', nombre: 'Áreas verdes — Tareas semanales', categoria: 'Áreas Verdes', sistema: 'Jardines y Prados', tipoMantencion: 'Preventivo', frecuencia: 'Semanal', responsable: 'Jardinero General', tiempoEstimado: 240, centroCostoCodigo: 'CC-ARV-01', esRecurrente: true },
  { codigo: 'LV-10', nombre: 'Ciclovía y sendero — Mantenimiento', categoria: 'Infraestructura', sistema: 'Ciclovía y Sendero', tipoMantencion: 'Preventivo', frecuencia: 'Semanal', responsable: 'Auxiliar de Servicios Generales', tiempoEstimado: 120, centroCostoCodigo: 'CC-INF-01', esRecurrente: true },
  { codigo: 'LV-11', nombre: 'Inspección quincenal infraestructura', categoria: 'Infraestructura', sistema: 'Ciclovía / Muelles / Iluminación', tipoMantencion: 'Preventivo', frecuencia: 'Quincenal', responsable: 'Jefe de Mantenimiento', tiempoEstimado: 180, centroCostoCodigo: 'CC-INF-01', esRecurrente: true },
  { codigo: 'LV-12', nombre: 'Piscinas — Control quincenal completo', categoria: 'Piscina', sistema: 'Piscinas', tipoMantencion: 'Preventivo', frecuencia: 'Quincenal', responsable: 'Operario de Piscinas', tiempoEstimado: 240, centroCostoCodigo: 'CC-PIS-01', esRecurrente: true },
  { codigo: 'LV-13', nombre: 'Áreas verdes — Mantenimiento mensual', categoria: 'Áreas Verdes', sistema: 'Jardines y Prados', tipoMantencion: 'Preventivo', frecuencia: 'Mensual', responsable: 'Jardinero General', tiempoEstimado: 300, centroCostoCodigo: 'CC-ARV-01', esRecurrente: true },
  { codigo: 'LV-14', nombre: 'Laguna — Revisión mensual sala de máquinas', categoria: 'Piscina', sistema: 'Laguna / Sala de máquinas', tipoMantencion: 'Preventivo', frecuencia: 'Mensual', responsable: 'Técnico en Maquinarias', tiempoEstimado: 180, centroCostoCodigo: 'CC-PIS-01', esRecurrente: true },
  { codigo: 'LV-15', nombre: 'Club House — Mantención mensual integral', categoria: 'Infraestructura', sistema: 'Club House / Canchas / Quinchos', tipoMantencion: 'Preventivo', frecuencia: 'Mensual', responsable: 'Jefe de Mantenimiento', tiempoEstimado: 360, centroCostoCodigo: 'CC-INF-01', esRecurrente: true },
  { codigo: 'LV-16', nombre: 'Juegos infantiles — Inspección técnica mensual', categoria: 'Infraestructura', sistema: 'Juegos Infantiles', tipoMantencion: 'Preventivo', frecuencia: 'Mensual', responsable: 'Jefe de Mantenimiento', tiempoEstimado: 120, centroCostoCodigo: 'CC-INF-01', esRecurrente: true },
  { codigo: 'LV-17', nombre: 'Estacionamientos — Mantención mensual', categoria: 'Infraestructura', sistema: 'Estacionamientos / Acceso', tipoMantencion: 'Preventivo', frecuencia: 'Mensual', responsable: 'Personal de Mantención', tiempoEstimado: 120, centroCostoCodigo: 'CC-INF-01', esRecurrente: true },
  { codigo: 'LV-18', nombre: 'Mantención mayor trimestral', categoria: 'Infraestructura', sistema: 'Todos los sectores críticos', tipoMantencion: 'Preventivo', frecuencia: 'Trimestral', responsable: 'Jefe de Mantenimiento', tiempoEstimado: 480, centroCostoCodigo: 'CC-INF-01', esRecurrente: true },
  { codigo: 'LV-19', nombre: 'Revisión semestral completa', categoria: 'Infraestructura', sistema: 'Condominio completo', tipoMantencion: 'Preventivo', frecuencia: 'Semestral', responsable: 'Jefe de Mantenimiento', tiempoEstimado: 600, centroCostoCodigo: 'CC-INF-01', esRecurrente: true },
  { codigo: 'LV-20', nombre: 'Revisión anual — Certificaciones y estado', categoria: 'Infraestructura', sistema: 'Condominio completo', tipoMantencion: 'Legal', frecuencia: 'Anual', responsable: 'Ente Certificador', tiempoEstimado: 480, centroCostoCodigo: 'CC-INF-01', esRecurrente: true },
]
